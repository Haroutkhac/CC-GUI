...
export default function GameCanvas({ projects, sessions, onNPCInteract, onTableInteract, onDeleteTable, onDismissNPC, inputPaused }) {
  ...
  }, [onNPCInteract, onTableInteract, onDeleteTable, onDismissNPC]);
